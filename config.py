...
class Config:
    ...
    # Добавляем материалы для курсов
    MATERIALS = {
        "🇯🇵 Японский язык": {
    ...
    TABLE_NAMES = {
        'active': 'registrations_active',
        'trial': 'registrations_trial',
        'studying': 'registrations_studying',
        'frozen': 'registrations_frozen',
        'waiting_payment': 'registrations_payment',
        'completed': 'registrations_completed',
